...
Highly accurate SNES emulation. Whether to use the Accuracy, or Balanced or Performance core depends on how much accuracy you want to give up for game performance. Please check the [compatibility section](https://buildbot.libretro.com/docs/library/bsnes_balanced/#compatibility) for more information.
...
*RetroArch databases that are associated with the bsnes Balanced core*
...
The bsnes Balanced core creates directories named 'bsnes' in RetroArch's...
...
*The bsnes Balanced core supports the following controller setting(s), bolded controller settings are the default for the specified user(s):*
...
| bsnes Balanced | RetroPad                                               | *SNES Joypad / Multitap*                                |
|----------------|--------------------------------------------------------|---------------------------------------------------------|
