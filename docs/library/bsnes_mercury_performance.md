...
*The bsnes-mercury Performance core supports a max of 5 users.*

*The bsnes-mercury Performance core supports 6 controller setting(s), the bolded controller setting is default:*
